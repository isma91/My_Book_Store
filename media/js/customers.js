        ...
        if (data.error === null) {
            if (data.data === false || data.data.length === 0) {
                ...
                $.each(data.data, function(index, object) {
                    all_customers = all_customers + '<tr><td>' + object.firstname + '</td><td>' + object.lastname + '</td><td>' + object.adresse + '</td><td>' + object.city + '</td><td>' + object.email + '</td><td>' + object.order + '</td><td><a class="waves-effect btn-flat" href="?page=edit_customer&id=' + object.id + '">Edit</a></td><td><button class="waves-effect btn-flat" id=remove_customer" id="' + object.id + '">Remove</button></td></tr>';
                });
